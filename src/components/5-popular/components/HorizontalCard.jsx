  ...
  return (
    <div className='flex min-w-[152px] flex-col gap-7'>
        <div className='relative'>
            <img className='h-[200px] rounded-xl w-auto' src={`https://image.tmdb.org/t/p/original${img}`} height={0} width={0}/>
            <div className='absolute h-10 w-10 bg-emerald-950 rounded-full -bottom-5 left-5 flex justify-center items-center text-white font-bold text-[13px]'>{value}</div>
        </div>
        <div className=''>

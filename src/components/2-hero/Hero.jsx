...
export default function Home () {
    ...
    return (
        <div 
            className=" bg-cover md:bg-cover bg-no-repeat bg-top relative px-10 md:px-40 py-10 md:py-0 md:min-h-[50vh] flex flex-col items-start justify-center " 
            style={{backgroundImage: `url(${heroImage})`,
        }}>
            <div className="absolute top-0 left-0 h-full w-full bg-gradient-to-tr from-blue-800 to-blue-900 opacity-70 z-[1]" ></div>
            <h1 className="cursor-pointer text-5xl md:text-5xl font-bold text-white z-[2]">Welcome</h1>
            <h2 className="cursor-pointer text-2xl md:text-3xl font-bold mt-4 md:mt-2 text-white z-[2]">
